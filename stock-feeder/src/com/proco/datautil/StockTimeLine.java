...
public class StockTimeLine extends RedisModelBase {
	public String columnPath = "stocktimeline";
	long timestamp = System.currentTimeMillis();
	
	public StockTimeLine(String ex, String date, String rowkeyString) {
	...
	public StockTimeLine(String ex, String date, NavigableMap<String, String> dataHash) {
		super(date, dataHash);
		// TODO Auto-generated constructor stub
	    ...
	    long dataMillis = timestamp - baseMillis;
	    
	    
	    score = 99999999L- dataMillis;
	    ...
	    this.rowkeyString = (new StringBuffer(ex).append("_").append(productid)).toString();
	    chk = true;		
	    this.redisKeyString = columnPath+"_"+date+"_"+rowkeyString;
	    this.hashcode = (redisKeyString).hashCode();
	    if(this.hashcode<0) this.hashcode = this.hashcode -(this.hashcode*2);
	...
	public void setScore(long nscore) {
		score=nscore;
	}
