...
public class StockQuote extends RedisModelBase {

	String ex = "";
	long timestamp = System.currentTimeMillis();
	public String columnPath = "stockquote";
	
	public StockQuote(String date, String rowkeyString) {
	...
	public StockQuote(String date, NavigableMap<String, String> dataHash, boolean replay) {
		super(date, dataHash);
		// TODO Auto-generated constructor stub
	...
	public static void main(String[] args) {
		...
		StockQuote stockinfo = new StockQuote("20120701",aa,false);
		stockinfo.insertSCF();
