...
public class StockQuoteIndex extends RedisModelBase {

	String ex = "";
	long timestamp = System.currentTimeMillis();
	public String columnPath = "stockquoteindex";
	
	public StockQuoteIndex(String date, String rowkeyString) {
	...
	public StockQuoteIndex(String date, NavigableMap<String, String> dataHash, boolean replay) {
		super(date, dataHash);
		// TODO Auto-generated constructor stub
	    ...
	    this.rowkeyString = (new StringBuffer(pid).append("_").append(productid).append("_").append(date).append("_").append(last)).toString();
		this.redisKeyString = columnPath+"_"+date+"_"+rowkeyString;
	...
	public static void main(String[] args) {
		...
		StockQuoteIndex stockinfo = new StockQuoteIndex("20120701",aa,false);
		stockinfo.insertSCF();
