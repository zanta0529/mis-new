...
public class StockOhlc extends RedisModelBase {
	...
	static java.util.concurrent.atomic.AtomicLong getCount = new java.util.concurrent.atomic.AtomicLong(0L);
	...
	public static StockOhlc getStockOhlc(String ex, String ch,String date, String time) {
		...
		if(ch.equals("t00.tw") || ch.equals("o00.tw"))
			System.out.println("StockOhlc.getStockOhlc.get :"+ch+" "+getCount.get()+" "+aa.redisKeyString);
		aa.get();
		if(ch.equals("t00.tw") || ch.equals("o00.tw"))
			System.out.println("StockOhlc.getStockOhlc.get :"+ch+" "+getCount.get()+" "+aa.redisKeyString+" ok "+aa.dataHash.size() );
