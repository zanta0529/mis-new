...
public class OddDetail extends RedisModelBase {
	String ex = "";
	long timestamp = System.currentTimeMillis();
	public String columnPath = "odddetail";
	
	public OddDetail(String date, String rowkeyString) {
	...
	public OddDetail(String date, NavigableMap<String, String> dataHash, boolean replay) {
		super(date, dataHash);
		// TODO Auto-generated constructor stub
	...
	public static void main(String[] args) {
		...
		aa.put("%","09:00:00");
		aa.put("#","6.tse|1234");
		OddQuote sd = new OddQuote("20120717",aa,true);
		sd.insertCF();
