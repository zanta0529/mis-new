...
public class StockTickerTime extends RedisModelBase {
	...
	public StockTickerTime(String ex, String date, String rowkeyString) {
	...
	public boolean insertTime(Map<String,RedisCommandInfo> ks){
	...
	public boolean insertTime(List<RedisCommandInfo> ks){
		org.json.JSONObject js = new org.json.JSONObject();
		for(java.util.Map.Entry<String,String> ent : this.dataHash.entrySet()){
			try {
				js.put(ent.getKey(), ent.getValue());
