...
for(String key : keys){
  ...
  //FRMSA Volumn
  org.json.JSONObject jsTSE = getIndex("tse", fqy, date, rdate, time,"t00.tw");
  org.json.JSONObject jsOTC = getIndex("otc", fqy, date, rdate, time,"o00.tw");
  if(jsTSE!=null && jsOTC!=null) {
	  String volTSE = jsTSE.optString("v","0");
	  String volOTC = jsOTC.optString("v","0");
	  long fv = Utility.parseLong(volTSE)+Utility.parseLong(volOTC);
	  if(fv > 0){
	    v = String.valueOf(fv);
	    js1.put("v",v);
	  }	  
...
public static JSONObject getIndex(String ex,String fqy,String date,String rdate,String time,String symbol) throws Exception {
org.json.JSONObject js = new JSONObject();
