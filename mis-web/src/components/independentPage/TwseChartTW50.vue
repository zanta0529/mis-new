...
const loadStockInfo1 = async () => {
  const data = await getMisOhlcTW50();
  if (data.rtcode == '0000') {
    let result;
...
const loadOhcl = (cPrice, upper, lower, maxValume, yesPrice, valumeArr) => {
  ...
  if (chart && inputMaxValue > chart.yAxis[0].max) {
    chart.yAxis[0].max = inputMaxValue;
    chart = null;
  }
    ...
    <div class="d-flex justify-content-center w-100">
      ...
      >
        ...
        <div class="position-relative">
          ...
          >
            <div class="d-flex justify-content-center gap-3 fs-11 fw-medium">
              <p class="mb-0 fs-12">{{ time }}</p>
