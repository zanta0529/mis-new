...
const detailData = ref({
  titleType: 'MENU_CATEGORIES_ETN_GTSM',
...
const theadData = computed(() => {
  return [
    ...
    { name: t('REFERENCE_PRICE_N'), width: '8%', theadAlignment: 'end' },
...
const updateDataPeriodically = () => {
  nIntervId = setInterval(() => {
    fetchData('otc', 'B1', currentPage.value);
  }, 5000);
};
  ...
  <div>
    ...
    <div class="container-fluid">
      <div class="row justify-content-between">
        <p class="fs-2 text-black fw-medium p-0 mb-0 col-3">{{ t('MENU_CATEGORIES_ETN_GTSM') }}</p>
    ...
    <manual-table>
      <manual-table-item>{{ t('GROUP_NOTE_OTC_ETN') }}</manual-table-item>
