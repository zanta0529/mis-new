...
const detailData = ref({
  titleType: 'CATEGORIES_FOREIGN_GTSM_TITLE',
...
const updateDataPeriodically = () => {
  nIntervId = setInterval(() => {
    fetchData('otc', 'Q0', currentPage.value);
  }, 5000);
};
  ...
  <div>
    ...
    <div class="container-fluid">
      <div class="row justify-content-between">
        <p class="fs-2 text-black fw-medium p-0 mb-0 col-4">
          {{ t('CATEGORIES_FOREIGN_GTSM_TITLE') }}
        </p>
