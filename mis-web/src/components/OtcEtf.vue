...
const detailData = ref({
  titleType: 'MENU_CATEGORIES_ETF_GTSM',
...
const countValue = (value) => {
  ...
  fetchData(storedType, storedCode, currentPage.value); // 設定子組件資料
};
...
const updateDataPeriodically = () => {
  nIntervId = setInterval(() => {
    fetchData('otc', 'B0', currentPage.value);
  }, 5000);
};
  ...
  <div>
    <div class="container-fluid">
      <div class="row justify-content-between">
        <p class="fs-2 text-black fw-medium p-0 mb-0 col-3">{{ t('MENU_CATEGORIES_ETF_GTSM') }}</p>
    ...
    <manual-table>
      ...
      <manual-table-item>
        ...
        <a
          ...
          href="https://www.tpex.org.tw/web/link/etf/etf02.php?l=zh-tw&t=545&t2=538&s=3"
          target="_blank"
        >
          {{ t('GROUP_NOTE_ETF2') }}
        </a>
